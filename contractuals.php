...
<head>
    ...
    <title>Contractuals budget</title>
    <link rel="stylesheet" href="style.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
</head>
<body >
    <div class="nav_panel">
        <div class="page_title_div">Contractuals budget</div>
    ...
    <div class="containers"> 
        ...
        <div id="input_form">
            <form method="post" action="process_contractuals_budget.php" class="form-container">
                <div class="form-column">
                    <div class="form-group">
                        <label for="Type">Type:</label>
                        <select name="Type" id="Type">
                            <option value="Office machine servicing">Office machine servicing</option>
                            <option value="Lab machine servicing">Lab machine servicing</option>
                ...
                <div class="form-column">
                    ...
                    <div class="form-group">
                        <label for="Communication">Incurred cost %:</label>
                        <input type="number" name="incurred_cost" id="incurred_cost">
                    </div>                    
                </div>                   
            </form>
        </div>
        ...
        <div class="view_table">
            ...
            <div class = 'bottom_buttons'>
                ...
                <div class="next_button"><a href="Others.php">Next</a></div>
            </div>
        </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#displayDataBtn").click(function() {
                ...
                var incurred_cost = $('#incurred_cost').val();
                ...
                $.ajax({
                    type: "POST",
                    url: "process_contractuals_budget.php", // Your PHP script that processes the form data
                    data: {Type: Type, Description: Description, Quarter: Quarter, Quantity: Quantity, Cost_per_unit: Cost_per_unit,
                        funders_exchange_rate: funders_exchange_rate, incurred_cost: incurred_cost},
            ...
            function storeTableContentInSession() {
                ...
                $.ajax({
                    type: "POST",
                    url: "store_contractuals_table.php", // Path to your PHP script
            ...
            $("#submitBtn").click(function() {
               ...
               $.ajax({
                    type: "POST",
                    url: "process_contractuals_total.php", // Path to your PHP script
                    data: {finalTotal: finalTotal, finalConvertedTotal: finalConvertedTotal},
                    success: function(response) {
                        console.log(response); // Log server response
                        alert("Contractuals totals saved.");
                    },
                    error: function(xhr, status, error) {
                        console.error('AJAX Error:', error);
                        alert("Unable to set session variable.");
                    }
                });
            });
